...
print("The employee id1 is " ,d.get("employee_id1","230938098")) #default
...
print(d.items())
for var in d.items():
    print(f'The key[{var[0]}] has value[ {var[1]}]')    
print("line")
...
print(d)
d|= {"new_key_from_pipe":1,"new_key1_from_pipe":2}
#or
d.update({"new_key_from_update":1,"new_key1_from_update":2})
print(d)
...
print(d)
d|= {'employee_id': 55555,'address': "new_address_via_pipe"}
print(d)
...
print(my_dict.setdefault("name1","CHANGES AGAIN")) # defaulted_value
